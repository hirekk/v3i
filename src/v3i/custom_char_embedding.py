...
from cumulative_cross_product import cumulative_cross_product
...
class OctonionCharEmbedding(nn.Module):
    def __init__(self, vocab_size, device=None):
        ...
        """
        super(OctonionCharEmbedding, self).__init__()
...
if __name__ == "__main__":
    ...
    print("Word embeddings shape (should be [3, 7]):", output.shape) 